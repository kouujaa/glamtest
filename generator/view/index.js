...
module.exports = class extends Generator {
  ...
  write() {
    ...
    this.fs.copyTpl(
      ...
      this.destinationPath(`src/components${this.viewName}/index.js`),
      {
    ...
    this.fs.copyTpl(
      ...
      this.destinationPath(`src/components${this.viewName}/styles.scss`),
      {
        viewName: this.viewName
      }
    )
    ...
    this.fs.copyTpl(
      ...
      this.destinationPath(`src/components${this.viewName}/container.js`),
      {
        viewName: this.viewName
      }
    )

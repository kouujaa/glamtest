...
export default class TermsAndConditionsComponent extends PureComponent {
  ...
  render() {
    return (
      <div className="tnc_wrap">
        ...
        <h5 class="font-weight-bold">Interpretation and Definitions</h5>
        ...
        <ul>
          ...
          <li><strong>Company</strong> (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to The Glam Plug Inc, 8700 general currie rd.</li>
          ...
          <li><strong>Website</strong> refers to The Glam Plug, accessible from glamplug.herokuapp.com</li>    <li><strong>You</strong> means the individual accessing or using the Service, or the company, or other legal entity on behalf of which such individual is accessing or using the Service, as applicable.</li>
        </ul>

        <h5 class="font-weight-bold">Acknowledgement</h5>
        ...
        <h5 class="font-weight-bold">Termination</h5>
        ...
        <h5 class="font-weight-bold">"AS IS" and "AS AVAILABLE" Disclaimer</h5>
        ...
        <h5 class="font-weight-bold">Disputes Resolution</h5>
        <p>If You have any concern or dispute about the Service, You agree to first try to resolve the dispute informally by contacting the Company.</p>

        <h5 class="font-weight-bold">For European Union (EU) Users</h5>
        <p>If You are a European Union consumer, you will benefit from any mandatory provisions of the law of the country in which you are resident in.</p>


        <h5 class="font-weight-bold">United States Legal Compliance</h5>
        <p>You represent and warrant that (i) You are not located in a country that is subject to the United States government embargo, or that has been designated by the United States government as a “terrorist supporting” country, and (ii) You are not listed on any United States government list of prohibited or restricted parties.</p>

        <h5 class="font-weight-bold">Severability and Waiver</h5>
        <h2>Severability</h2>
        ...
        <h5 class="font-weight-bold">Translation Interpretation</h5>
        ...
        <h5 class="font-weight-bold">Changes to These Terms and Conditions</h5>
        ...
        <ul>
        <li>By email: info@theglamplug.ca</li>
        <li>By visiting this page on our website: glamplug.herokuapp.com/faq</li>
        </ul>
      </div> */}
      <div class="container mt-5 mb-5">
        <div class="row">
          <div class="col-12">
            <div class="termsCondition p-3 border">
              <h4 class="font-weight-bold">Terms and Conditions</h4>
              <p>Last updated: April 01, 2020

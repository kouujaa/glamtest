...
import { HairStylistSchema } from "../../../utils/validations";
import "./styles.scss";
...
export default class ViewDrawer extends PureComponent {
  constructor(props) {
    ...
    this.state = {
      ...
      HairStyleData: this.props.HairStyleData,
      editHairStyle: this.props.editHairStyle,
      editHairStyleId: this.props.editHairStyleId,
  ...
  static getDerivedStateFromProps(nextProps, prevState) {
    if (nextProps) {
      return {
        ...
        HairStyleData: nextProps.HairStyleData,
        editHairStyle: nextProps.editHairStyle,
        editHairStyleId: nextProps.editHairStyleId,
  ...
  render() {
    const { editHairStyle } = this.state;
    if (editHairStyle === false) {
      this.setState({
        image: "",
        title: "",
        subtitle: "",
      ...
      <div>
        ...
        >
          <Formik
            ...
            enableReinitialize
            validationSchema={HairStylistSchema}
            onSubmit={this.props.handlehairStylist}
          >
            {({
              values,
              handleChange,

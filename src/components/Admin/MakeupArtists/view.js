...
import { MakeupArtistSchema } from '../../../utils/validations'
import './styles.scss'
      ...
      <div>
        ...
        >
          <Formik
            ...
            enableReinitialize
            validationSchema={MakeupArtistSchema}
            onSubmit={this.props.handlemakeupArtist}
          >
            {({
              values,
              handleChange,
              ...
              isSubmitting
                ...
                <label className="label_form">Image</label>
                  ...
                  <div className="btn_wrap">
                    <button type="button" className="btn" onClick={handleSubmit} >{editMakeupArtist ? 'Edit' : 'Submit'}</button>
                  </div>
                </Form>
              )}
          </Formik>
